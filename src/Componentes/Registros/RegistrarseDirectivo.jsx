        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          <div>
            <select name="curso" id="curso" className="block text-sm font-semibold leading-6 text-gray-900">
              <option value="" className="block text-sm font-semibold leading-6 text-gray-900">Cargo</option>
              <option value="" className="block text-sm font-semibold leading-6 text-gray-900">Regente</option>
              <option value="" className="block text-sm font-semibold leading-6 text-gray-900">Vicedirector</option>
              <option value="" className="block text-sm font-semibold leading-6 text-gray-900">Director</option>
              <option value="" className="block text-sm font-semibold leading-6 text-gray-900">Asesora</option>
            </select>
            <div className="mt-2.5">
            </div>
          </div>
